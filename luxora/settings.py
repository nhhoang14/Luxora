...
SECRET_KEY = config('DJANGO_SECRET_KEY', default='fallback-key-for-dev')
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'cart.context_processors.cart_context',  # vẫn giữ nguyên
            ],
        },
    },
]
...
npm_path = config('NPM_BIN_PATH', default='')
